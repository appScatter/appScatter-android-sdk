...
public final class ASLog {
    private static final String TAG = "ASLog";
    private static final String PACKAGE_NAME = ASLog.class.getPackage().getName();
    ...
    public static void setEnabled(final boolean isDebug, final boolean enabled) {
        ASLog.isDebug = isDebug;
        ASLog.enabled = enabled;
    }
