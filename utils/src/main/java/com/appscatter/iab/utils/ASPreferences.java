...
public class ASPreferences {
    ...
    public ASPreferences(@NonNull final Context context, @Nullable String postfix,
            final int mode) {
    ...
    public ASPreferences(@NonNull final Context context) {
        this(context, null);
    }
