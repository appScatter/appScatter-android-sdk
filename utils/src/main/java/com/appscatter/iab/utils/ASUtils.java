...
public final class ASUtils {
     ...
     * @throws java.lang.SecurityException If a caller doesn't have the {@link android.Manifest.permission#ACCESS_NETWORK_STATE}
     *                                     permission.
     */
    ...
    public static boolean isMainProcess(@NonNull final Context context) {
        ...
        final List<ActivityManager.RunningAppProcessInfo> runningProcesses = activityManager
    ...
    /**
     * Checks if the Google Play Store is installed in the user device
     *
     * @param context Context of the application
     * @return if Google Play Store is installed
     */
    public static boolean isGooglePlayInstalled(Context context) {
        List<ApplicationInfo> packages = context.getPackageManager().getInstalledApplications(PackageManager.GET_META_DATA);

        for (ApplicationInfo appInfo : packages) {
            if (appInfo.packageName.equals(GooglePlayStorePackageNameOld) ||
                    appInfo.packageName.equals(GooglePlayStorePackageNameNew)) {
                return true;
            }
        }
        return false;
