...
public class AptoidePurchase extends AptoideModel {
    ...
    public AptoidePurchase(@NonNull final String originalJson) throws JSONException {
        super(originalJson);
        ...
        @PurchaseState final int purchaseStateCode = jsonObject.optInt(NAME_PURCHASE_STATE, PurchaseState.PURCHASED);
