...
//    }
    ...
    @Nullable
    private static ArrayList<String> getList(@Nullable final Bundle bundle, @NonNull final String key) {
    ...
    @NonNull
    private static Bundle putList(@NonNull final Bundle bundle, @Nullable final ArrayList<String> list, @NonNull final String key) {
    ...
    @NonNull
    private static Bundle addList(@NonNull final Bundle bundle, @Nullable final ArrayList<String> list, @NonNull final String key) {
        if (list != null && !list.isEmpty()) {
    ...
    @NonNull
    static Bundle addSkuDetails(@NonNull final Bundle bundle, @Nullable final ArrayList<String> skuDetailsList) {
    ...
    @NonNull
    static Bundle addDataList(@NonNull final Bundle bundle, @Nullable final ArrayList<String> purchaseData) {
    ...
    @NonNull
    static Bundle addItemList(@NonNull final Bundle bundle, @Nullable final ArrayList<String> purchaseData) {
    ...
    @NonNull
    static Bundle addSignatureList(@NonNull final Bundle bundle, @Nullable final ArrayList<String> purchaseData) {
    ...
    @NonNull
    static Bundle putSkuList(@NonNull final Bundle bundle, @Nullable final ArrayList<String> skuList) {
    ...
    @NonNull
    static Bundle putResponse(@NonNull final Bundle bundle, @Response final int response) {
